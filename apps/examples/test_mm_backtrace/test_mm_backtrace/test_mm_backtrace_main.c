 ...
 *
 * (For a precise, table-based backtrace see the test_mm_schedbt example,
 *  which uses sched_backtrace() / CONFIG_SCHED_BACKTRACE.)
 *
 * This produces the leak's call path; resolve the addresses with:
 *   arm-none-eabi-addr2line -f -e build/output/bin/common_dbg <addr> ...
 ****************************************************************************/
